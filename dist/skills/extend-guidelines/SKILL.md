...
設計承認の前に、CONTRIBUTING.md の次の共通節（「全シナリオ共通: 過剰適合の点検」、新設を含む拡張では「全シナリオ共通: 新設の評価可能性」もあわせて）を実施・確認し、各節の記録義務・執行点に従って点検結果を記録すること。点検の観点・記録先・執行点の定義は CONTRIBUTING.md 側が正である。
