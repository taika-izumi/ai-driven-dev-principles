...
本 repo の既存課題を新構造へ移行し、2026-07-05 振り返りの未起票バックログ6件＋brainstorming 中に検出した課題1件を起票する。全変更完了後に template を同期する。
...
`docs/working/issues/README.md` をブロック01の2セクション形式に書き換え、0001（system, closed）と新規7件の行を配置する。
