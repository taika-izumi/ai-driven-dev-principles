...
| [0094](0094-artifact-bloat-addressed-as-growth-pattern.md) | 成果物の肥大化（Issue-0088）は用途別対応ではなく成長様式への対策として扱う | Proposed | 2026-08-15 |
| [0095](0095-issue-materials-lifecycle-split-colocation.md) | 長期化した Issue の関連情報は「検討中はフォルダ集約・close で性質別置き場へ移設」で配置する | Proposed | 2026-08-15 |
| [0096](0096-issue-folder-promotion-trigger-and-role-system.md) | Issue のフォルダ昇格は観測可能な条件で提案し、フォルダ内は 4 役割・番号接頭辞の固定体系とする | Proposed | 2026-08-15 |
| [0097](0097-issue-granularity-one-problem-many-questions.md) | Issue の粒度は「1 Issue ＝ 1 問題」とし、複数の問いの内包を認める | Proposed | 2026-08-15 |
| [0098](0098-norm-placement-behavior-in-skills-structure-in-docs.md) | 規範の記載先は「発火条件・手順はスキル、構造・命名・分量の定義はプロジェクト文書」で分け、境界をまたぐ複写を禁止する | Proposed | 2026-08-15 |
