...
- 2026-08-31: ADR-0120 実装で pre-finalization-review が 34,193B → 41,539B（+21.5%。2 型分類・分布外検知・体数型別既定ほか 8 編集）。start-work の分割前サイズ（34,676B）を超過した。分割判断の発生条件（前行）が成立した状態。
