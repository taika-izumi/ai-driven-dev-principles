...
- 再試験の完了: 2026-09-17、修正352499c・11群検証・独立レビュー後、新規af00b8c5/7b8f20ebで承認2台の試験を完了した。全8台stopped、既存6台不変。実験記録は`docs/records/experiments/2026-09-17-v3-task9-proposal-probes.md`。以下の未実施・停止中の記載は初回試験時の経緯である。
