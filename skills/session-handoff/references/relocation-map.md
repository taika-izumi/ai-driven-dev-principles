...
- cycle-reset（`op-cycle-reset.md`）の申し送りの有効性の点検の前段（教訓型を落とす前に移設する）
...
| レビュー結果・検査の詳細 | 計画・課題・記録類の正本（進行中の作業＝標準: `docs/working/plans/` / `docs/working/issues/`、追跡型の記録＝標準: `docs/records/`） | 確認の記録 1 行（参照のみ） |
